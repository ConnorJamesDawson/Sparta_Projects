...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<SpartanTest> SpartanTests { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SpartanTest>(entity =>
        {
            entity.HasKey(e => e.SpartanId).HasName("PK_SpartanID");

            entity.ToTable("SpartanTest");

            entity.Property(e => e.SpartanId).HasColumnName("SpartanID");
            entity.Property(e => e.FirstName).HasMaxLength(50);
            entity.Property(e => e.LastName).HasMaxLength(50);
            entity.Property(e => e.Phone).HasMaxLength(11);
            entity.Property(e => e.University).HasMaxLength(11);
        });
